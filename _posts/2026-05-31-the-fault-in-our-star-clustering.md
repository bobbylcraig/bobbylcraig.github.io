...
{% include viz-mount.html class="cx cx-fig" reserve="star-naive" fig="naive" src="/assets/data/2026-05-31-the-fault-in-our-star-clustering/stars.json" %}
...
{% include viz-mount.html class="cx cx-fig cx-clean" reserve="star-clean" src="/assets/data/2026-05-31-the-fault-in-our-star-clustering/stars.json" %}
...
{% include viz-mount.html class="cx cx-fig" reserve="star-sphere" fig="sphere" src="/assets/data/2026-05-31-the-fault-in-our-star-clustering/stars.json" %}
...
{% include viz-mount.html class="cx cx-fig" reserve="star-chain" fig="chain" src="/assets/data/2026-05-31-the-fault-in-our-star-clustering/stars.json" %}
...
<div class="cx">
  {% include viz-mount.html id="cx-chart" class="" reserve="star-chart" src="/assets/data/2026-05-31-the-fault-in-our-star-clustering/stars.json" %}
</div>
