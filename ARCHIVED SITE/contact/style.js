...
!function($, Foundation) {
    ...
    var Motion = {
        animateIn: function(element, animation, /*duration,*/
        cb) {
            animate(true, element, animation, cb);
        },

        animateOut: function(element, animation, /*duration,*/
        cb) {
...
!function($) {
    $.fn.addTouch = function() {
        ...
        var handleTouch = function(event) {
            ...
            simulatedEvent.initMouseEvent(type, true, true, window, 1, first.screenX, first.screenY, first.clientX, first.clientY, false, false, false, false, 0 /*left*/
            , null);
...
!function(Foundation, $) {
    ...
    Abide.defaults = {
        ...
        // options: fieldChange, manual, submit
    ...
    Slider.prototype._setHandlePos = function($hndl, location, noInvert, cb) {
        ...
        if (this.options.doubleSided) {
            ...
            if (isLeftHndl) {
                ...
                dim = /*Math.abs*/
                ((percent(this.$handle2.position()[lOrT] + halfOfHandle, elemDim) - parseFloat(pctOfBar)) * 100).toFixed(this.options.decimal) + '%';
                css['min-' + hOrW] = dim;
