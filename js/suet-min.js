...
function(t, e) {
    ...
    c.init = function(t) {
        ...
        if (c.initCore.initialized = !0, c.options = c.options || {}, c.options.hashChangeInterval = c.options.hashChangeInterval || 100, c.options.safariPollInterval = c.options.safariPollInterval || 500, c.options.doubleCheckInterval = c.options.doubleCheckInterval || 500, c.options.disableSuid = c.options.disableSuid || !1, c.options.storeInterval = c.options.storeInterval || 1e3, c.options.busyDelay = c.options.busyDelay || 250, c.options.debug = c.options.debug || !1, c.options.initialTitle = c.options.initialTitle || n.title, c.options.html4Mode = c.options.html4Mode || !1, c.options.delayInit = c.options.delayInit || !1, c.intervalList = [], c.clearAllIntervals = function() {
                ...
                var t = "undefined" != typeof i && "undefined" != typeof i.log && "undefined" != typeof i.log.apply,
                    e = n.getElementById("log"),
                    s, o, r, a, l;
                for (t ? (a = Array.prototype.slice.call(arguments), s = a.shift(), "undefined" != typeof i.debug ? i.debug.apply(i, [s, a]) : i.log.apply(i, [s, a])) : s = "\n" + arguments[0] + "\n", o = 1, r = arguments.length; r > o; ++o) {
                    if (l = arguments[o], "object" == typeof l && "undefined" != typeof u) try {
                        l = u.stringify(l)
                    } catch (h) {}
                    s += "\n" + l + "\n"
                }
                return e ? (e.value += s + "\n-----\n", e.scrollTop = e.scrollHeight - e.clientHeight) : t || d(s), !0
            }, c.getInternetExplorerMajorVersion = function() {
                var t = c.getInternetExplorerMajorVersion.cached = "undefined" != typeof c.getInternetExplorerMajorVersion.cached ? c.getInternetExplorerMajorVersion.cached : function() {
                ...
                var t = c.isInternetExplorer.cached = "undefined" != typeof c.isInternetExplorer.cached ? c.isInternetExplorer.cached : Boolean(c.getInternetExplorerMajorVersion());
                return t
            }, c.options.html4Mode ? c.emulated = {
                pushState: !0,
                hashChange: !0
            } : c.emulated = {
                ...
                hashChange: Boolean(!("onhashchange" in t || "onhashchange" in n) || c.isInternetExplorer() && c.getInternetExplorerMajorVersion() < 8)
            }, c.enabled = !c.emulated.pushState, c.bugs = {
                setHash: Boolean(!c.emulated.pushState && "Apple Computer, Inc." === s.vendor && /AppleWebKit\/5([0-2]|3[0-3])/.test(s.userAgent)),
                safariPoll: Boolean(!c.emulated.pushState && "Apple Computer, Inc." === s.vendor && /AppleWebKit\/5([0-2]|3[0-3])/.test(s.userAgent)),
                ...
                var t = c.getLocationHref().replace(/[#\?].*/, "").replace(/[^\/]+$/, function(t, e, i) {
                    return /[^\/]$/.test(t) ? "" : t
                }).replace(/\/+$/, "") + "/";
                return t
                ...
                var i = t,
                    n = t.substring(0, 1);
                return e = "undefined" == typeof e ? !0 : e, /[a-z]+\:\/\//.test(t) || (i = "/" === n ? c.getRootUrl() + t.replace(/^\/+/, "") : "#" === n ? c.getPageUrl().replace(/#.*/, "") + t : "?" === n ? c.getPageUrl().replace(/[\?#].*/, "") + t : e ? c.getBaseUrl() + t.replace(/^(\.\/)+/, "") : c.getBasePageUrl() + t.replace(/^(\.\/)+/, "")), i.replace(/\#$/, "")
            }, c.getShortUrl = function(t) {
                var e = t,
                    i = c.getBaseUrl(),
                    n = c.getRootUrl();
                return c.emulated.pushState && (e = e.replace(i, "")), e = e.replace(n, "/"), c.isTraditionalAnchor(e) && (e = "./" + e), e = e.replace(/^(\.\/)+/g, "./").replace(/\#$/, "")
            ...
            }, c.store = {}, c.idToState = c.idToState || {}, c.stateToId = c.stateToId || {}, c.urlToId = c.urlToId || {}, c.storedStates = c.storedStates || [], c.savedStates = c.savedStates || [], c.normalizeStore = function() {
                c.store.idToState = c.store.idToState || {}, c.store.urlToId = c.store.urlToId || {}, c.store.stateToId = c.store.stateToId || {}
            }, c.getState = function(t, e) {
                "undefined" == typeof t && (t = !0), "undefined" == typeof e && (e = !0);
                var i = c.getLastSavedState();
                return !i && e && (i = c.createStateObject()), t && (i = c.cloneObject(i), i.url = i.cleanUrl || i.url), i
                ...
                if (!e)
                    ...
                    for (; e = (new Date).getTime() + String(Math.random()).replace(/\D/g, ""), "undefined" != typeof c.idToState[e] || "undefined" != typeof c.store.idToState[e];);
                    c.stateToId[i] = e, c.idToState[e] = t
                }
                return e
            }, c.normalizeState = function(t) {
                var e, i;
                return t && "object" == typeof t || (t = {}), "undefined" != typeof t.normalized ? t : (t.data && "object" == typeof t.data || (t.data = {}), e = {}, e.normalized = !0, e.title = t.title || "", e.url = c.getFullUrl(t.url ? t.url : c.getLocationHref()), e.hash = c.getShortUrl(e.url), e.data = c.cloneObject(t.data), e.id = c.getIdByState(e), e.cleanUrl = e.url.replace(/\??\&_suid.*/, ""), e.url = e.cleanUrl, i = !c.isEmptyObject(e.data), (e.title || i) && c.options.disableSuid !== !0 && (e.hash = c.getShortUrl(e.url).replace(/\??\&_suid.*/, ""), /\?/.test(e.hash) || (e.hash += "?"), e.hash += "&_suid=" + e.id), e.hashedUrl = c.getFullUrl(e.hash), (c.emulated.pushState || c.bugs.safariPoll) && c.hasUrlDuplicate(e) && (e.url = e.hashedUrl), e)
                ...
                var e, i, n, s;
                return s = -1 != t.indexOf("#") ? t.split("#")[0] : t, i = /(.*)\&_suid=([0-9]+)$/.exec(s), n = i ? i[1] || t : t, e = i ? String(i[2] || "") : "", e || !1
                ...
                var i = null,
                    n, s;
                return e = e || !1, n = c.extractId(t), n && (i = c.getStateById(n)), i || (s = c.getFullUrl(t), n = c.getIdByUrl(s) || !1, n && (i = c.getStateById(n)), !i && e && !c.isTraditionalAnchor(t) && (i = c.createStateObject(null, null, s))), i
                ...
                var e = !1,
                    i, n, s;
                return c.savedStates.length && (i = t.id, n = c.getLastSavedState(), s = n.id, e = i === s), e
            }, c.saveState = function(t) {
                return c.isLastSavedState(t) ? !1 : (c.savedStates.push(c.cloneObject(t)), !0)
            }, c.getStateByIndex = function(t) {
                var e = null;
                return e = "undefined" == typeof t ? c.savedStates[c.savedStates.length - 1] : 0 > t ? c.savedStates[c.savedStates.length + t] : c.savedStates[t]
                ...
                var i, s;
                return e !== !1 && c.busy() ? (c.pushQueue({
                    scope: c,
                    callback: c.setHash,
                    args: arguments,
                    queue: e
                }), !1) : (c.busy(!0), i = c.extractState(t, !0), i && !c.emulated.pushState ? c.pushState(i.data, i.title, i.url, !1) : c.getHash() !== t && (c.bugs.setHash ? (s = c.getPageUrl(), c.pushState(null, null, s + "#" + t, !1)) : n.location.hash = t), c)
            }, c.escapeHash = function(e) {
                var i = c.normalizeHash(e);
                return i = t.encodeURIComponent(i), c.bugs.hashEscape || (i = i.replace(/\%21/g, "!").replace(/\%26/g, "&").replace(/\%3D/g, "=").replace(/\%3F/g, "?")), i
                ...
                var e = t.title,
                    i;
                e || (i = c.getStateByIndex(0), i && i.url === t.url && (e = i.title || c.options.initialTitle));
                try {
                    n.getElementsByTagName("title")[0].innerHTML = e.replace("<", "&lt;").replace(">", "&gt;").replace(" & ", " &amp; ")
                } catch (s) {}
                return n.title = e, c
            }, c.queues = [], c.busy = function(t) {
                if ("undefined" != typeof t ? c.busy.flag = t : "undefined" == typeof c.busy.flag && (c.busy.flag = !1), !c.busy.flag) {
                    a(c.busy.timeout);
                    var e = function() {
                        var t, i, n;
                        if (!c.busy.flag)
                            for (t = c.queues.length - 1; t >= 0; --t) i = c.queues[t], 0 !== i.length && (n = i.shift(), c.fireQueueItem(n), c.busy.timeout = r(e, c.options.busyDelay))
                    };
                    c.busy.timeout = r(e, c.options.busyDelay)
                }
                return c.busy.flag
            }, c.busy.flag = !1, c.fireQueueItem = function(t) {
                return t.callback.apply(t.scope || c, t.args || [])
            }, c.pushQueue = function(t) {
                return c.queues[t.queue || 0] = c.queues[t.queue || 0] || [], c.queues[t.queue || 0].push(t), c
            }, c.queue = function(t, e) {
                return "function" == typeof t && (t = {
                    callback: t
                }), "undefined" != typeof e && (t.queue = e), c.busy() ? c.pushQueue(t) : c.fireQueueItem(t), c
            }, c.clearQueue = function() {
                return c.busy.flag = !1, c.queues = [], c
            }, c.stateChanged = !1, c.doubleChecker = !1, c.doubleCheckComplete = function() {
                ...
                return c.stateChanged = !1, c.doubleCheckClear(), c.bugs.ieDoubleCheck && (c.doubleChecker = r(function() {
                    return c.doubleCheckClear(), c.stateChanged || t(), !0
                }, c.options.doubleCheckInterval)), c
            }, c.safariStatePoll = function() {
                var e = c.extractState(c.getLocationHref()),
                    i;
                return c.isLastSavedState(e) ? void 0 : (i = e, i || (i = c.createStateObject()), c.Adapter.trigger(t, "popstate"), c)
            }, c.back = function(t) {
                return t !== !1 && c.busy() ? (c.pushQueue({
                    scope: c,
                    callback: c.back,
                    args: arguments,
                    queue: t
                }), !1) : (c.busy(!0), c.doubleCheck(function() {
                    c.back(!1)
                }), p.go(-1), !0)
            ...
            return c.isLastSavedState(o) ? c.busy(!1) : (c.storeState(o), c.expectedStateId = o.id, p.pushState(o.id, o.title, o.url), c.Adapter.trigger(t, "popstate")), !0
            ...
            c.busy(!0);
            var o = c.createStateObject(e, i, n);
            return c.isLastSavedState(o) ? c.busy(!1) : (c.storeState(o), c.expectedStateId = o.id, p.replaceState(o.id, o.title, o.url), c.Adapter.trigger(t, "popstate")), !0
        };
        if (o) {
            try {
        ...
        c.Adapter.bind(t, "unload", c.clearAllIntervals), c.saveState(c.storeState(c.extractState(c.getLocationHref(), !0))), o && (c.onUnload = function() {
            var t, e, i;
            try {
        ...
        }, c.intervalList.push(l(c.onUnload, c.options.storeInterval)), c.Adapter.bind(t, "beforeunload", c.onUnload), c.Adapter.bind(t, "unload", c.onUnload)), c.emulated.pushState || (c.bugs.safariPoll && c.intervalList.push(l(c.safariStatePoll, c.options.safariPollInterval)), ("Apple Computer, Inc." === s.vendor || "Mozilla" === (s.appCodeName || "")) && (c.Adapter.bind(t, "hashchange", function() {
...
function(t, e) {
    ...
    function o(e) {
        if (s(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
            ...
            var C = t(o.height);
            return C !== !1 && (a.height = C + (b ? 0 : m + w)), a.innerWidth = a.width - (g + _), a.innerHeight = a.height - (m + w), a.outerWidth = a.width + y, a.outerHeight = a.height + v, a
        }
    }
...
function(t, e) {
    ...
    u.ontransitionend = function(t) {
        ...
        this.removeTransitionStyles(), this.element.removeEventListener(l, this, !1),
...
function(t, e) {
    ...
    return n._resetLayout = function() {
        ...
        for (var h = this._getOption("originTop"), u = (h ? n.top : n.bottom) + i.outerHeight, d = a; l >= d; d++) this.colYs[d] = Math.max(u, this.colYs[d])
...
function(t, e) {
    ...
    $.throttle = i = function(t, i, n, s) {
        function o() {
            ...
            var h = this,
                u = +new Date - a,
                d = arguments;
            s && !r && o(), r && clearTimeout(r), s === e && u > t ? o() : i !== !0 && (r = setTimeout(s ? l : o, s === e ? t - u : t))
        }
        var r, a = 0;
    ...
    var u = function() {
        ...
        c = {
            ...
            prepareFb: function() {
                var e = this,
                    i = t(this.element);
                i.trigger("thumbloaddone.fluidbox"), c.measure.fbElements.call(this), e.bindEvents(), i.addClass("fluidbox--ready"), e.bindListeners(), i.trigger("ready.fluidbox")
            },
            measure: {
                viewport: function() {
                    l.viewport = {
    ...
    t.extend(s.prototype, {
        init: function() {
            var e = this,
                i = t(this.element),
                n = i.find("img").first();
            if (c.measure.viewport(), (!e.instanceData || !e.instanceData.initialized) && i.is("a") && 1 === i.children().length && (i.children().is("img") || i.children().is("picture") && 1 === i.find("img").length) && "none" !== i.css("display") && "none" !== i.children().css("display") && "none" !== i.parents().css("display")) {
                i.removeClass("fluidbox--destroyed"), e.instanceData = {}, e.instanceData.initialized = !0, e.instanceData.originalNode = i.html(), h += 1, e.instanceData.id = h, i.addClass("fluidbox__instance-" + h), i.addClass("fluidbox--initialized"), c.dom.call(e), i.trigger("init.fluidbox");
                var s = new Image;
                n.width() > 0 && n.height() > 0 ? c.prepareFb.call(e) : (s.onload = function() {
                    c.prepareFb.call(e)
                }, s.onerror = function() {
        ...
        open: function() {
            ...
            if (o.append(r), i.removeClass("fluidbox--closed").addClass("fluidbox--loading"), c.checkURL(n.attr("src"))) return e.close(), !1;
            s.css({
                "background-image": "url(" + c.formatURL(n.attr("src")) + ")",
                opacity: 1
            ...
            e.settings.immediateOpen ? (i.addClass("fluidbox--opened fluidbox--loaded").find(".fluidbox__wrap").css({
                ...
                if (i.trigger("imageloaddone.fluidbox"), 1 === e.instanceData.state) {
                    if (e.instanceData.thumb.natW = a.naturalWidth, e.instanceData.thumb.natH = a.naturalHeight, i.removeClass("fluidbox--loading"), c.checkURL(a.src)) return e.close({
                        error: !0
                    }), !1;
                    s.css({
                        "background-image": "url(" + c.formatURL(a.src) + ")"
                    }), e.compute()
                }
            }, a.onerror = function() {
                e.close({
            ...
            }, a.src = i.attr("href")) : (a = new Image, a.onload = function() {
                return i.trigger("imageloaddone.fluidbox"), i.removeClass("fluidbox--loading").addClass("fluidbox--opened fluidbox--loaded").find(".fluidbox__wrap").css({
                    zIndex: e.settings.stackIndex + e.settings.stackIndexDelta
                }), i.trigger("openstart.fluidbox"), c.checkURL(a.src) ? (e.close({
                    error: !0
                }), !1) : (s.css({
                    "background-image": "url(" + c.formatURL(a.src) + ")"
        ...
        compute: function() {
            ...
            e.settings.maxWidth > 0 ? (a = e.settings.maxWidth, h = a / c) : e.settings.maxHeight > 0 && (h = e.settings.maxHeight, a = h * c);
            var f, g, m, y, v;
            p > c ? (f = h < l.viewport.h ? h : l.viewport.h * e.settings.viewportFill, m = f / d, y = a * (d * m / h) / u, v = m) : (g = a < l.viewport.w ? a : l.viewport.w * e.settings.viewportFill, y = g / u, m = h * (u * y / a) / d, v = y), e.settings.maxWidth && e.settings.maxHeight && console.warn("Fluidbox: Both maxHeight and maxWidth are specified. You can only specify one. If both are specified, only the maxWidth property will be respected. This will not generate any error, but may cause unexpected sizing behavior.");
            var _ = o.scrollTop() - n.offset().top + .5 * d * (v - 1) + .5 * (o.height() - d * v),
                w = .5 * u * (v - 1) + .5 * (o.width() - u * v) - n.offset().left,
        ...
        close: function(e) {
            ...
            return null === i.instanceData.state || typeof i.instanceData.state == typeof n || 0 === i.instanceData.state ? !1 : (i.instanceData.state = 0, s.trigger("closestart.fluidbox"), s.removeClass(function(t, e) {
        ...
        bindListeners: function() {
            var e = this,
                i = t(this.element),
                n = function() {
                    c.measure.viewport(), c.measure.fbElements.call(e), i.hasClass("fluidbox--opened") && e.compute()
                };
    ...
    s.Defaults = {
        ...
        var i = this.current(),
            ...
            a = this.minimum(),
            l = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(s) > r / 2 && (s += -1 * o * r), t = i + s, (n = ((t - a) % r + r) % r + a) !== t && l >= n - s && n - s > 0 && (i = n - s, t = n, this.reset(i))) : this.settings.rewind ? (l += 1, t = (t % l + l) % l) : t = Math.max(a, Math.min(l, t)), this.speed(this.duration(i, t, e)), this.current(t), this.$element.is(":visible") && this.update()
...
function(t, e, i, n) {
    ...
    s.Defaults = {
        ...
        return e.wrap('<div class="owl-video-wrapper"' + r + "></div>"), this._core.settings.lazyLoad && (l = "data-src", h = "owl-lazy"), a.length ? (d(a.attr(l)), a.remove(), !1) : void("youtube" === i.type ? (o = "//img.youtube.com/vi/" + i.id + "/hqdefault.jpg", d(o)) : "vimeo" === i.type ? t.ajax({
            type: "GET",
...
function($) {
    ...
    function t() {
        $(".page__content").find("img:first").imagesLoaded(function() {
            $(".portfolio-wrap").masonry({
                ...
                transitionDuration: 0
            }), $("body").removeClass("loading"), $("body").removeClass("menu--open")
        }), $(".active-link").removeClass("active-link");
        var t = e.substr(-1);
        "/" === e ? $('a[href="' + e + '"]').addClass("active-link") : "/" === t ? $('a[href="' + e.slice(0, -1) + '"]').addClass("active-link") : $('a[href="' + e + '"]').addClass("active-link"), Waypoint.destroyAll();
        var i = 0;
        $(".gallery").each(function() {
            ...
            var e = "gallery-" + i;
            t.attr("id", e);
            var n = t.attr("data-columns");
            t.append('<div class="gallery__wrap"></div>'), t.children("img").each(function() {
                $(this).appendTo("#" + e + " .gallery__wrap")
            }), t.find(".gallery__wrap img").each(function() {
                var t = $(this).attr("src");
                $(this).wrapAll('<div class="gallery__item"><a href="' + t + '" class="gallery__item__link"></div></div>').appendTo()
            }), t.imagesLoaded(function() {
                if ("0" === n) {
                    t.addClass("gallery--carousel"), t.children(".gallery__wrap").addClass("owl-carousel"), t.children(".gallery__wrap").owlCarousel({
                        items: 1,
                        loop: !0,
                        mouseDrag: !1,
                        touchDrag: !0,
                    ...
                    var i = new Waypoint({
                            ...
                            handler: function(e) {
                                "down" === e && t.children(".gallery__wrap").trigger("stop.owl.autoplay"), "up" === e && t.children(".gallery__wrap").trigger("play.owl.autoplay")
                            },
                            offset: "-100%"
                        }),
                        s = new Waypoint({
                            element: document.getElementById(e),
                            handler: function(e) {
                                "down" === e && t.children(".gallery__wrap").trigger("play.owl.autoplay"), "up" === e && t.children(".gallery__wrap").trigger("stop.owl.autoplay")
                            },
                            offset: "100%"
                        })
                } else t.addClass("gallery--grid"), t.children(".gallery__wrap").masonry({
                    itemSelector: ".gallery__item",
                    transitionDuration: 0
                }), t.find(".gallery__item__link").fluidbox({
                    loader: !0
                });
            ...
            if ($(this).attr("src").indexOf("youtube") >= 0 || $(this).attr("src").indexOf("vimeo") >= 0) {
                var t = $(this).attr("width"),
                    e = $(this).attr("height"),
                    i = e / t * 100;
                $(this).wrapAll('<div class="video-wrap"><div class="video" style="padding-bottom:' + i + '%;"></div></div>')
            }
        })
    }
    ...
    n.Adapter.bind(window, "statechange", function() {
        ...
        $("body").addClass("loading"), $(".page-loader").load(s.hash + " .page__content", function() {
            ...
            var n = 400,
                s = $(".page-loader").find("#body-classes").attr("class");
            setTimeout(function() {
                $(".page .page__content").remove(), $(".page-loader .page__content").appendTo(".page"), $("body").attr("data-page-url", window.location.pathname), e = $("body").attr("data-page-url"), i = $(".page__content").attr("data-page-title"), document.title = i, $("body").removeClass().addClass(s), t()
            }, n)
        })
    }), $(document).on("click", "a", function(t) {
        t.preventDefault();
        var s = $(this).attr("href");
        s.indexOf("http") >= 0 ? window.open(s, "_blank") : $(this).hasClass("js-no-ajax") ? window.location = s : $(this).hasClass("js-contact") ? $(".modal--contact").addClass("modal--on") : $(this).hasClass("js-signup") ? $(".modal--signup").addClass("modal--on") : $(this).is(".gallery__item__link") || (e = s, n.pushState(null, i, s))
    ...
    }), t(), $(document).on("click", ".js-menu-toggle", function() {
